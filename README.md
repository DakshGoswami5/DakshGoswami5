...
## 🚀 Full-Stack MERN Developer | AI-Integrated Web Apps

I build production-ready full-stack applications with secure authentication, real-time systems, and AI-powered features.

Focused on scalable backend architecture, clean frontend UI, and practical product development.
...
### Frontend
JavaScript • React.js • Tailwind CSS • Responsive UI

### Backend
Node.js • Express.js • REST APIs • JWT Auth

### Database & Cloud
MongoDB • ImageKit • Render • Vercel

### AI Integration
Gemini API • Generative AI • Face-API
